        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-6 md:p-8">
            ...
            <div className="mb-6">
              ...
              {(meal.recipeLink || meal.source.url) && (
                <a
                  href={meal.recipeLink || meal.source.url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-aubergine-100 text-aubergine-700 rounded-md hover:bg-aubergine-200 transition-colors font-medium"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
